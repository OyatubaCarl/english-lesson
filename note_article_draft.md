# 歌・日本語混じり文・構文解析・シャドウイング——認知科学に基づく英語学習の多段階アプローチ
...
このサイトには「英語＋日本語ルビ」表示モードがあります。たとえば、こんな文章を読むことができます：

> 現代の若者は、親世代と異なる生活を送る。ファストフード、parking して車で移動、mixture の食文化。
...
入門英語（Funnics Island）には「絵本」表示モードがあります。物語の流れを追いながら英文を読む形式です。
