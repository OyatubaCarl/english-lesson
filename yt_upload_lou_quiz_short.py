"""ルー語クイズShort (lou_quiz_short_v1.mp4) を YouTube に限定公開でアップロード。

usage: python3 yt_upload_lou_quiz_short.py [unlisted|public]
既定: unlisted
"""
...
TAGS = [
    ...
    "日本語混じり", "歌で覚える英語", "Shorts", "Teacher Tacos English",
]
